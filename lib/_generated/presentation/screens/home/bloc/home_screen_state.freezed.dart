...
part of '../../../../../presentation/screens/home/bloc/home_screen_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeScreenState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error));
}
...
@override
String toString() {
  return 'HomeScreenState(isLoading: $isLoading, error: $error)';
}
...
class _HomeScreenState extends HomeScreenState {
  const _HomeScreenState({this.isLoading = false, this.error = AppError.none}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeScreenState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error));
}
